...
export const SubscriptionBanner = () => {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Create an account for 10 free detections daily
              </p>
            </div>
          </div>
          <Button
  ...
  if (subscription?.plan_type === 'free') {
    ...
    return (
      <div className={`rounded-2xl p-4 mb-6 ${isLow ? 'bg-warning/10 border border-warning/30' : 'bg-secondary/50 border border-border'}`}>
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            {isLow ? (
          ...
          <Button
            ...
            className={isLow ? "bg-gradient-to-r from-warning to-primary text-white" : ""}
          >
            Upgrade
          </Button>
        </div>
  ...
  if (subscription?.plan_type === 'lifetime') {
    return (
      <div className="bg-gradient-to-r from-warning/10 to-primary/10 border border-warning/30 rounded-2xl p-4 mb-6">
        <div className="flex items-center gap-3">
  ...
  if (subscription?.plan_type === 'premium_monthly') {
    return (
      <div className="bg-gradient-to-r from-accent/10 to-primary/10 border border-accent/30 rounded-2xl p-4 mb-6">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
